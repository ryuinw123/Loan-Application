...
public abstract class ManagerNaviBarBase extends AnchorPane {
    ...
    public ManagerNaviBarBase() {
        ...
        navi.setOnAction(this::GProfile3);
        ...
        navi2.setOnAction(this::GHistory2);
        ...
        imageView.setLayoutX(99.0);
        imageView.setPickOnBounds(true);
        imageView.setPreserveRatio(true);
        imageView.setEffect(dropShadow0);
        anchorPane3.setLayoutX(1.0);
        anchorPane3.setLayoutY(70.0);
        ...
        UserText3.setLayoutX(28.0);
        UserText3.setLayoutY(70.0);
        UserText3.setText("Name");
        UserText3.setFont(new Font("Segoe UI Bold", 25.0));
        label1.setLayoutX(28.0);
        label1.setLayoutY(102.0);
        label1.setText("Class : MANAGER");
        ...
        Createpage();
        File file = new File("src/loan/image/Manager.jpg");
        Image image = new Image(file.toURI().toString());
        imageView.setImage(image);
        ConnectionUtil.GetName(UserText3);
        ...
        anchorPane3.getChildren().add(UserText3);
    ...
    protected abstract void GProfile3(javafx.event.ActionEvent actionEvent);

    protected abstract void GLR3(javafx.event.ActionEvent actionEvent);

    protected abstract void GHistory2(javafx.event.ActionEvent actionEvent);

    protected abstract void Logout(javafx.event.ActionEvent actionEvent);

    protected abstract void Edit(javafx.event.ActionEvent actionEvent);
