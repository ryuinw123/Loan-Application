...
public abstract class AgentRequestPage02hBase extends AnchorPane {
    ...
    protected final FontAwesomeIconView LRiHome;
    ...
    public AgentRequestPage02hBase() {
        ...
        LRiHome = new FontAwesomeIconView();
        label0 = new Label();
        label1 = new Label();
        hBox = new HBox();
        vBox = new VBox();
        ...
        LRiHome.setGlyphName("HOME");
        LRiHome.setGlyphSize(50);
        ...
        LRiHome.setLayoutX(14.0);
        LRiHome.setLayoutY(57.0);
        ...
        hBox7.setLayoutX(21.0);
        hBox7.setLayoutY(68.0);
        hBox7.setPrefHeight(3.0);
        hBox7.setPrefWidth(380.0);
        hBox7.setStyle("-fx-background-color: #5D5D5D;");
        ...
        ChoAnn.setText("Label");
        ChoAnn.setFont(new Font("Segoe UI", 18.0));
        HBox.setMargin(ChoAnn, new Insets(14.0, 0.0, 0.0, 14.0));
        ...
        anchorPane0.getChildren().add(LRiHome);
        ...
        ConnectionUtil.HLoanRequest(LHOME, LNO, LSubdistrict, LDIstract, LProvince, Lpostal, YN, YID, YDOB, YCareer, ChoAnn, Yaccount, Yphone, YEmail, AgentRequestPage01Controller.Reference);
    }
